...
const addTopNavFooter = function () {
  ...
  const navBStrign = `<ul>
    ...
    <ul>
        <li><button class="filterbtn" onclick="filterSelection('cheese')">Cheese</button></li>
        <li><button class="filterbtn" onclick="filterSelection('spirits')">Spirits</button></li>
        <li><button class="filterbtn" onclick="filterSelection('other')">Other</button></li>
    </ul>
    </li>
    <li>
        <a href="Basket.html">
